...
- 정본 코드: `chat/adapter/in/web/InitEvent.java`, `chat/adapter/in/web/ChatController.java`.
...
> final 미수신 시에도 빈 문자열을 저장한다. 정본: `chat/adapter/out/agent/ChatAgentClient.java`(파싱),
> `chat/application/ChatStreamService.java`(저장).
