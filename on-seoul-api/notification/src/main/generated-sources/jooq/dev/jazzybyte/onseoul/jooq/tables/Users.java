...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>users.provider</code>.
     */
    ...
    /**
     * The column <code>users.provider_id</code>.
     */
    public final TableField<UsersRecord, String> PROVIDER_ID = createField(DSL.name("provider_id"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>users.email_enc</code>.
     */
    public final TableField<UsersRecord, String> EMAIL_ENC = createField(DSL.name("email_enc"), SQLDataType.VARCHAR(4000), this, "");

    /**
     * The column <code>users.email_hash</code>.
     */
    public final TableField<UsersRecord, String> EMAIL_HASH = createField(DSL.name("email_hash"), SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>users.phone_enc</code>.
     */
    public final TableField<UsersRecord, String> PHONE_ENC = createField(DSL.name("phone_enc"), SQLDataType.VARCHAR(4000), this, "");

    /**
     * The column <code>users.phone_hash</code>.
     */
    public final TableField<UsersRecord, String> PHONE_HASH = createField(DSL.name("phone_hash"), SQLDataType.VARCHAR(64), this, "");
