...
class SeoulOpenApiAdapterIntegrationTest {
    ...
    void setUp() {
        ...
        // baseUrl 기본값(http://openapi.seoul.go.kr:8088) 사용
    ...
    // -----------------------------------------------------------------------
    // 5개 카테고리 전체 수집 — 데이터 존재 + 필드 무결성 검증
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // 페이지네이션 — 1페이지 수집 결과 수가 pageSize 이하인지 확인
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // 도메인 필드 매핑 검증 — 주요 필드가 정상 파싱되는지 확인
    // -----------------------------------------------------------------------
