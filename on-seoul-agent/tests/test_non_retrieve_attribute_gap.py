"""non-RETRIEVE action 자가교정 — attribute_gap 완화.
...
from tests._non_retrieve_support import _attribute_gap_intake, _state
    ...
    async def test_relaxed_hit_sets_retry_relaxed_and_notice(self):
        ...
        with (
            ...
            patch(
                ...
                AsyncMock(side_effect=_hydrate),
            ),
        ):
            graph = AgentGraph(
                intake=intake,
