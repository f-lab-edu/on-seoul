"""Retrieval Critic 시스템 프롬프트 및 Few-shot 예시 (L1 retrieval-critic Phase 2).
...
#   3. REPLAN — 결과가 질의 의도와 표류(drift) → reformulate_query (L1 Phase 4)
...
CRITIC_FEW_SHOT_EXAMPLES = [
    ...
    },
    {
        ...
        # 자연어로 재구성해 재탐색한다(reformulate_query). OI-3 흡수(§3-3).
        "summary": (
